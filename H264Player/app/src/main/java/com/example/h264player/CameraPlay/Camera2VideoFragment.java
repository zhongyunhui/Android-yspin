...
public class Camera2VideoFragment extends Fragment {// implements View.OnClickListener, ActivityCompat.OnRequestPermissionsResultCallback
    ...
    private Camera2VideoViewModel mViewModel;
    ...
    public View onCreateView(@NonNull LayoutInflater inflater, @Nullable ViewGroup container,
        ...
        return inflater.inflate(R.layout.camera2_video_fragment, container, false);
    }

    @Override
    public void onActivityCreated(@Nullable Bundle savedInstanceState) {
        super.onActivityCreated(savedInstanceState);
        mViewModel = ViewModelProviders.of(this).get(Camera2VideoViewModel.class);
